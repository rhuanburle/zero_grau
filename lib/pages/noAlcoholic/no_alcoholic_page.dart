      ...
      children: [
        ...
        Expanded(
          child: ListView.builder(
              itemCount: ctrl.noAlcoolicList.length,
              itemBuilder: (_, index) {
                return Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 10),
                  child: Card(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ctrl.noAlcoolicList[index].name,
                                  style: TextStyle(
                                      fontSize: 16,
                                ...
                                Text(
                                  ctrl.noAlcoolicList[index].description,
                                ...
                                Row(
                                  children: [
                                    Text(
                                      'R\$ ${ctrl.noAlcoolicList[index].price}',
                                      style: const TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.bold,
                                          color: Colors.black),
